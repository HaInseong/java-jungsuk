...
/**
 * hashCode메서드란?
 * 객체의 해시코드(정수값)를 반환하는 메서드 = 객체를 식별하는데 사용하는 정수값
 * Object클래스의 hashCode()는 객체의 주소를 int로 변환해서 반환
 * Object클래스의 hashCode()는 native메서드인데, native메서드는 OS가 가지고 있는 메서드라는 의미.
 * OS내에 C언어로 작성되어 있다. 그래서 Object 클래스의 hashCode() 메서드를 보면 구현부가 없다.
 * equals()를 오버라이딩하면, hashCode()도 오버라이딩해야 한다.
 * ★ 왜나하면 equals()의 결과가 true인 두 객체의 해시코드는 같아야하기 때문에
 * hashCode() 오버라이딩 이후에 객체마다 다른 해시코드 값이 필요할 때는 identityHashCode(Object obj)를 사용하면 된다.
 */
